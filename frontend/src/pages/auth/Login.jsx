    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      <nav className="flex justify-between items-center p-4 border-b border-gray-200 bg-white/80 backdrop-blur-sm">
        ...
        <div className="flex gap-4 text-sm font-medium text-gray-700">
          <Link to="/register" className="text-blue-700 hover:text-blue-800 font-semibold transition">
            Daftar
          </Link>
        </div>
      </nav>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold py-3 px-4 rounded-xl transition duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
                    <svg
